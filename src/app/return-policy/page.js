  ...
  return (
    <main className='py-20 lg:py-24 px-5 text-primary flex flex-col justify-center items-center'> 
     ...
     <h2 className='text-2xl uppercase tracking-wider font-bold text-center'>Returns & Refunds</h2>
      ...
      <section className=''>
        <h3 className='font-semibold opacity-80 lg:text-xl '>RETURN/EXCHANGE CONDITIONS:</h3>
        <ol className='text-sm list-decimal ml-5 mt-1 lg:text-lg '>
      ...
      <section>
      <h3 className='font-semibold opacity-80 lg:text-xl'>HOW TO RETURN:</h3>
        <ol className='text-sm list-decimal ml-5 mt-1 lg:text-lg '>
      ...
      <section>
        <h3 className='font-semibold opacity-80 lg:text-xl'>DAMAGES AND ISSUES:</h3>
        <p className='text-sm'>
      ...
      <section>
      <h3 className='font-semibold opacity-80 lg:text-xl'>ITEM NOT RECEIVED:</h3>
        <ol className='text-sm list-decimal ml-5 mt-1 lg:text-lg '>
      ...
      <section>
        <h3 className='font-semibold opacity-80 lg:text-xl'>ORDER CANCELATION:</h3>
        <p className='text-sm'>
