...
const Refund = () => {
  return (
    <main className="flex flex-col items-center justify-center px-5 py-20 text-primary lg:py-24">
      <div className="flex flex-col gap-6 lg:max-w-[75%]">
        <h1 className="text-center text-2xl font-bold uppercase tracking-wider lg:text-5xl">
          Returns & Refunds
        </h1>
        <section>
          <p className="px-1 text-xs italic text-gray-600 lg:text-sm">
            Edenmen is glad to accept returns of online-purchased products that
            are undamaged, unworn, and/or defective{" "}
            <span className="font-semibold">* within 30 days *</span> of the
            original purchase date. If you&apos;re not happy with your purchase,
            we can simply set you up with a refund or an exchange. To request a
            return or exchange, just get in touch with us within 30 days of
            receiving the item.
          </p>
        </section>
        <section className="">
          <h3 className="font-semibold opacity-80 lg:text-xl ">
            RETURN/EXCHANGE CONDITIONS:
          </h3>
          <ol className="ml-5 mt-1 list-decimal text-sm lg:text-lg ">
            <li>
        ...
        <section className="rounded-xl bg-gray-600 p-3 italic text-gray-200 lg:p-5 ">
          <h3 className="lg:text-lg">Note:</h3>
          <ul className="ml-3 list-disc text-xs lg:text-sm">
            <li>
        ...
        <section>
          <h3 className="font-semibold opacity-80 lg:text-xl">REFUND:</h3>
          <p className="text-sm">
        ...
        <section>
          <h3 className="font-semibold opacity-80 lg:text-xl">EXCHANGE:</h3>
          <ol className="ml-5 mt-1 list-decimal text-sm lg:text-lg ">
            <li>
        ...
        <section>
          ...
          <p className="text-sm">
            Your order will be fully refunded if it’s cancelled within 24 hours
            of purchase. Please submit a help ticket from Contact Us if you
            decide to cancel the order. For orders cancelled after 24 hours of
        ...
        <section>
          <h3 className="font-semibold opacity-80 lg:text-xl">CONTACT US:</h3>
          <p className="text-sm">
            If you have any other doubts or difficulties during the return
            process, please feel free to contact us through{" "}
            <Link href="/#contact" className="text-blue-500 underline">
              our online form
            </Link>
            , we will be always online and welcome your consultation.
          </p>
        </section>
      </div>
    </main>
